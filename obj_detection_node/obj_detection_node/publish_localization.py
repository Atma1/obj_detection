...
class Localization(Node):
    def __init__(self):
        ...
        self.image_height =  self.get_parameter("img_height").get_parameter_value().double_value
        self.image_width =  self.get_parameter("img_width").get_parameter_value().double_value
    ...
    def callback(self, detectionArray: DetectionArray):
        ...
        for detection in detectionArray:
            ...
            pixel_distance = get_distance(pixel=self.img_size, bbox_xy=bbox_xy)
        ...
        self.get_logger().info(f"Published ball localization")   
